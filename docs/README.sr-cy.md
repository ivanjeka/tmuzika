...
- Подесиве теме боја (комплетна конфигурација изгледа интерфејса)
- Глобални приступ подешавањима (тастер o у свим режимима: плејер, радио, менаџер фајлова)
...
| Taster | Akcija                                      |
|--------|---------------------------------------------|
| o      | Отвори подешавања (боје / пречице)          |
| b      | Ресетуј боје                                |
| ?      | Помоћ                                       |
| k      | Затвори програм                             |
...
| s            | Претрага                                      |
| ctrl+n       | Креирај нови фолдер                           |
| ctrl+t       | Креирај нови фајл                             |
...
| BACKSPACE    | Излаз из фајл менаџера                        |

---

## Подешавања

tmuzika пружа уграђен систем за подешавање:

- Промена боја интерфејса

Притисните `o` да отворите подешавања из било ког режима:
- tmuzika (музички плејер)
- tmuzika-radio
- tmuzika-fm (менаџер фајлова)

Сваки режим такође има сопствени екран помоћи (`?`).
