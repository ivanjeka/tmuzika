...
- Podesive teme boja (kompletna konfiguracija izgleda interfejsa)
- Podesive prečice na tastaturi (korisnički definisane komande)
- Globalni pristup podešavanjima (taster o u svim režimima: plejer, radio, menadžer fajlova)
...
| Taster | Akcija                                      |
|--------|---------------------------------------------|
| o      | Otvori podešavanja (boje / prečice)         |
| h      | Resetuj prečice                             |
| b      | Resetuj boje                                |
| ?      | Pomoć                                       |
...
| s            | Pretraga                                      |
| ctrl+n       | Kreiraj novi folder                           |
| ctrl+t       | Kreiraj novi fajl                             |
...
tmuzika pruža ugrađen sistem za podešavanje:

- Promena boja interfejsa
- Prilagođavanje prečica na tastaturi

Pritisnite `o` da otvorite podešavanja iz bilo kog režima:
- tmuzika (muzički plejer)
- tmuzika-radio
- tmuzika-fm (menadžer fajlova)

Svaki režim takođe ima sopstveni ekran pomoći (`?`).
