...
- Customizable color themes (full UI color configuration)
- Global configuration access (`o` key in all modes: player, radio, file manager)
...
| Key | Action                                      |
|-----|---------------------------------------------|
| o   | Open configuration (colors / key bindings)  |
| b   | Reset color                                 |
| ?   | Help                                        |
| k   | Exit program                                |
...
| BACKSPACE     | Quit file manager                     |

---

## Configuration

tmuzika provides a built-in configuration system:

- Change UI colors

Press `o` to open configuration from any mode:
- tmuzika (music player)
- tmuzika-radio
- tmuzika-fm (file manager)

Each mode also provides its own help screen (`?`).
